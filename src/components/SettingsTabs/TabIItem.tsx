...
export const TabItem = ({ value, title, isSelected = false }: TabItemProps) => {
  return (
    <Tabs.Trigger
      value={value}
      className={twMerge(
        "group relative px-1 pb-4 text-sm font-medium text-zinc-500 outline-none",
    ...
    >
      <span
        className={twMerge(
          ...
          "group-focus-visible:ring-2 group-focus-visible:ring-violet-400 group-focus-visible:ring-offset-4",
        )}
      >
        {title}
      </span>
