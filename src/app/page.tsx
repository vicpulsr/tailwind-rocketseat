        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.Root>
                <Input.Control id="firstName" defaultValue={"Victoria"} />
              </Input.Root>
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="lastName" defaultValue={"Pessato"} />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue={"victoria.pessato@gmail.com"}
              />
            </Input.Root>
          </div>

          <div className="gap-3 pt-5 lg:grid lg:grid-cols-form">
            <label
              htmlFor="photo"
              className="text-sm font-medium text-zinc-700 dark:text-zinc-300" 
            >
          ...
          <div className="gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Select placeholder="Select a timezone...">
              ...
              />
              <SelectItem
                text="Eastern Standard Time (UTC - 03:00)"
                value="utc3"
              />
            </Select>
          </div>
          ...
          <div className="gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                id="bio"
                defaultValue="I'm a Product Designer based in Melbourne, Australia. I specialise in UX/UI design, ..."
              />
            </div>
          </div>
